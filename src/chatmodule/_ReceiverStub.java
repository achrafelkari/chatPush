...
/**
* chatmodule/_ReceiverStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from chat.idl
* lundi 25 janvier 2016 22 h 12 CET
*/

public class _ReceiverStub extends org.omg.CORBA.portable.ObjectImpl implements chatmodule.Receiver
{
  ...
  public void message (String newMessage)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("_set_message", true);
                $out.write_string (newMessage);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
